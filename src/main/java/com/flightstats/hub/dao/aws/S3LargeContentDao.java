...
import com.flightstats.hub.util.ChunkResponse;
...
public class S3LargeContentDao implements ContentDao {
    ...
    public ContentKey insert(String channelName, Content content) {
        ...
        try {
            ...
            String name = this.s3BucketName.getS3BucketName();
            InitiateMultipartUploadRequest initRequest = new InitiateMultipartUploadRequest(name, s3Key);
            ...
            ChunkOutputStream outputStream = new ChunkOutputStream(chunk -> {
                try {
                    ...
                    //todo - gfm - not sure we need this
                    return new ChunkResponse(true, "ok");
                } catch (Exception e) {
                    logger.warn("?!?!", e);
                    throw e;
                }
            ...
            outputStream.close();
            CompleteMultipartUploadRequest compRequest = new CompleteMultipartUploadRequest(name, s3Key, initResponse.getUploadId(), partETags);
            ...
            //todo - gfm - delete the item in S3.
